...
Inline_object_1::Inline_object_1(QString json) {
...
void Inline_object_1::initializeModel() {
...
void Inline_object_1::fromJsonObject(QJsonObject json) {
...
QJsonObject Inline_object_1::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString Inline_object_1::getId() const {
    return id;
}
void Inline_object_1::setId(const QString &id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool Inline_object_1::is_id_Set() const{
    return m_id_isSet;
}

bool Inline_object_1::is_id_Valid() const{
    return m_id_isValid;
}

QString Inline_object_1::getPassword() const {
    return password;
}
void Inline_object_1::setPassword(const QString &password) {
    this->password = password;
    this->m_password_isSet = true;
}

bool Inline_object_1::is_password_Set() const{
    return m_password_isSet;
}

bool Inline_object_1::is_password_Valid() const{
    return m_password_isValid;
}

QString Inline_object_1::getName() const {
    return name;
}
void Inline_object_1::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

bool Inline_object_1::is_name_Set() const{
    return m_name_isSet;
}

bool Inline_object_1::is_name_Valid() const{
...
void Inline_object_1::setGender(const QString &gender) {
    this->gender = gender;
    this->m_gender_isSet = true;
}

bool Inline_object_1::is_gender_Set() const{
    return m_gender_isSet;
}

bool Inline_object_1::is_gender_Valid() const{
