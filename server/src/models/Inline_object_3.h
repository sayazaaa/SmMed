...
#ifndef Inline_object_3_H
#define Inline_object_3_H
...
public:
    Inline_object_3();
    Inline_object_3(QString json);
    ~Inline_object_3() override;
...
Q_DECLARE_METATYPE(HttpServer::Inline_object_3)

#endif // Inline_object_3_H
