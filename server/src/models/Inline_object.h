...
#ifndef Inline_object_H
#define Inline_object_H
...
public:
    Inline_object();
    Inline_object(QString json);
    ~Inline_object() override;
...
Q_DECLARE_METATYPE(HttpServer::Inline_object)

#endif // Inline_object_H
